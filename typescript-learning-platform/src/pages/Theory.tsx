...
export default function Theory() {
  ...
  const contentKey = `${lecture}_theory`;
    ...
    return (
      <div className="vp-content">
        <div id="markdown-content">
          ...
          <p>De theorie voor {lecture} kon niet worden geladen.</p>
        </div>
      </div>
    );
  }
    ...
    <>
      <div className="vp-page-title" style={{ paddingBottom: '0' }}>
        <div style={{ display: 'flex', gap: '20px', fontSize: '1.2rem', marginBottom: '10px' }}>
          <Link to={`/theory/${lecture}`} style={{ color: 'var(--vp-c-brand)', borderBottom: '2px solid var(--vp-c-brand)', paddingBottom: '5px', display: 'flex', alignItems: 'center', gap: '5px' }}>
          ...
          <Link to={`/exercise/${lecture}`} style={{ color: 'var(--vp-c-text-mute)', paddingBottom: '5px', display: 'flex', alignItems: 'center', gap: '5px' }}>
