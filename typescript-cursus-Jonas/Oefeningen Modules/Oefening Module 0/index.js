...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let voornaam = yield rl.question('Wat is je voornaam: ');
        let achternaam = yield rl.question('Wat is je familienaam: ');
        let leeftijdInput = yield rl.question('Wat is je leeftijd: ');
