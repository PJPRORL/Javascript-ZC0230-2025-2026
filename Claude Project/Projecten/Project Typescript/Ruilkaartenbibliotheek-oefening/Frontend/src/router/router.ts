...
export class Router {
  ...
  navigate(path: string) {
    ...
    // Toon de inhoud van de pagina waarnaar genavigeerd werd.
  ...
  /**
   * Doorzoek de DOM naar elementen met een data-link attribuut en voeg een event listener toe om te navigeren naar
   * de bijhorende pagina.
   *
   * @private
   */
  #setupRouter() {
